...
echo '$Monday === Enum\Base::UnserializeEnum(Enum\Base::SerializeEnum(DayOfWeek::Monday())): ' . var_export($Monday === Enum\Base::UnserializeEnum(Enum\Base::SerializeEnum(DayOfWeek::Monday())), true) . '<br />';
